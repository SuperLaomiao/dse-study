          ...
          content: (
            <div className="overflow-hidden rounded-[28px] border border-[rgba(24,51,33,0.18)] bg-[linear-gradient(135deg,#24432d_0%,#4d6842_62%,#6e845f_100%)] p-5 text-[var(--cream)] shadow-[0_24px_50px_rgba(27,53,34,0.24)]">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <a
                  href="/progress"
                  className="inline-flex min-w-[168px] items-center justify-center rounded-full border border-[rgba(255,250,243,0.7)] bg-[rgba(255,250,243,0.28)] px-5 py-3 text-sm font-semibold text-[var(--cream)] shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] transition hover:-translate-y-[1px] hover:bg-[rgba(255,250,243,0.4)]"
                >
